                ...
                <div id="modal-table1" class="table-responsive">
                  <table class="table">
                    ...
                    <tr>
                      ...
                      <td>{{ $aspects->no_sk_peringatan1 }}</td>
                    </tr>
                    <tr>
                      <th>Tanggal SK Peringatan 1</th>
                      <td>{{ $aspects->tgl_sk_peringatan1 }}</td>
                    </tr>
                    <tr>
                      <th>No SK Peringatan 2</th>
                      <td>{{ $aspects->no_sk_peringatan2 }}</td>
                    </tr>
                    <tr>
                      <th>Tanggal SK Peringatan 2</th>
                      <td>{{ $aspects->tgl_sk_peringatan2 }}</td>
                    </tr>
                    <tr>
                      <th>No SK Peringatan 3</th>
                      <td>{{ $aspects->no_sk_peringatan3 }}</td>
                    </tr>
                    <tr>
                      <th>Tanggal SK Peringatan 3</th>
                      <td>{{ $aspects->tgl_sk_peringatan3 }}</td>
                    </tr>
                    <tr>
                      <th>No SK Penyegelan</th>
                      <td>{{ $aspects->no_sk_penyegelan }}</td>
                    </tr>
                    <tr>
                      <th>Tanggal SK Penyegelan</th>
                      <td>{{ $aspects->tgl_sk_penyegelan }}</td>
                    </tr>
                    <tr>
                      <th>No SK Bantib Penyegelan</th>
                      <td>{{ $aspects->no_sk_bantib_penyegelan }}</td>
                    </tr>
                    <tr>
                      <th>Tanggal SK Pembongkaran</th>
                      <td>{{ $aspects->tgl_sk_pembongkaran }}</td>
                    </tr>
                    <tr>
                      <th>No SK Bantib Pembongkaran</th>
                      <td>{{ $aspects->tgl_sk_bantib_pembongkaran }}</td>
                    </tr>
                    <tr>
