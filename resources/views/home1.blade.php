              ...
              <div class="card-header">
                <div class="row">
                  <div class="col-6 mt-2">
                      <h3 class="card-title">List Semua Data Penertiban</h3>
                  </div>
                  <div class="col-6 text-right">
                      <a class="btn btn-success" href="{{asset("/create")}}">
                          Tambah Data
                      </a>
                  </div>
                </div>
        ...
        success: function (response) {
          ...
          console.log(res);
            ...
            $('.modal-footer-edit').html(
              ...
              <button type="button" onclick="store_json(`+id+`)" class="btn btn-success float-right mb-3 mr-3 toastrDefaultSuccess">Save changes</button>
              </form>`
            )
        }
    });
