...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('new/css/demo.css')}}" />
        <link rel="stylesheet" type="text/css" href="{{asset('new/css/style4.css')}}" />
		<script type="text/javascript" src="{{asset('new/js/modernizr.custom.86080.js')}}"></script>
    </head>
    <body id="p">
